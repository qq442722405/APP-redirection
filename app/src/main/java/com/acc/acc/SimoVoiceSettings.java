...
final class SimoVoiceSettings {
    static void show(MainActivity a){
        ...
        Switch close=new Switch(a);close.setChecked(a.prefs.getBoolean("simo_close_enabled",false));p.bind(17,close);
        ...
        p.action(18,()->SimoCloseTests.show(a));
        p.action(13,()->{
            a.prefs.edit().putBoolean("simo_close_enabled",close.isChecked()).putBoolean("simo_enabled",enabled.isChecked()).putBoolean("simo_boot",boot.isChecked()).putBoolean("simo_all_apps",all[0]).apply();
