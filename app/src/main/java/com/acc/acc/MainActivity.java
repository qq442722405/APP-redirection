...
public class MainActivity extends AppCompatActivity {
    ...
    void placeDesigned(View v, DesignElem e){
        ...
        if(v instanceof TextView){
            TextView tv=(TextView)v;
            if(e.fontSize>0) tv.setTextSize(android.util.TypedValue.COMPLEX_UNIT_PX,e.fontSize);
        }
    ...
    EditText designedEdit(DesignSpec d,String label,int occ,String value){
        ...
        x.setTextSize(android.util.TypedValue.COMPLEX_UNIT_PX,(e==null?16:e.fontSize));
