...
public class MainActivity extends AppCompatActivity {
    ...
    EditText designWallpaperInput;
    static final int REQ_DESIGN_WALLPAPER=19044;
    ...
    void pickDesignWallpaper(EditText target){
        designWallpaperInput=target;
        ...
        try{startActivityForResult(intent,REQ_DESIGN_WALLPAPER);}catch(Exception e){Toast.makeText(this,"无法打开图片选择器",Toast.LENGTH_SHORT).show();}
    }
    ...
    @Override protected void onActivityResult(int requestCode,int resultCode,Intent data){
        ...
        if(requestCode==REQ_DESIGN_WALLPAPER){
            ...
            if(designWallpaperInput!=null)designWallpaperInput.setText(uri.toString());
            designWallpaperInput=null;return;
        }
        try{
