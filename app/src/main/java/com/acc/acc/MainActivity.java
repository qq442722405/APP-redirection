...
public class MainActivity extends AppCompatActivity {
    ...
    @Override protected void onCreate(Bundle savedInstanceState){
        ...
        VehicleStatusService.sync(this);
    ...
    @Override protected void onResume(){
        ...
        if(!now)stopService(new Intent(this,VehicleStatusService.class));
    }
    ...
    @Override protected void onDestroy(){InAppDialog.clear(this);super.onDestroy();}
