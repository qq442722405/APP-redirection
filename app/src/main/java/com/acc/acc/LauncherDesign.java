...
final class LauncherDesign {
    ...
    void buildMain(){
        ...
        overlayGate(main.action(31,a::showFloatingPresetPicker));
    ...
    void settings(){
        ...
        p.action(16,()->VehicleStatusSettings.show(a));
    ...
    void interfaceOptions(){
        ...
        p.action(3,d::dismiss);p.action(4,()->{
            ...
            d.dismiss();buildMain();refreshOpenThemes();a.restartFloatingServiceSafe();VehicleStatusService.sync(a);toast("设置已保存");
        });show(d,p);
    }
