...
const pages={'主界面':40,'新建预设窗口':47,'添加APP':26,'设置':17,'界面选项':25,'悬浮窗口设置':35,'自动启动项目':11,'权限与诊断':7,'添加悬浮按钮':26,'单图标操作':9,'手势APP选择':26,'SIMO语音启动':19,'SIMO关闭测试':20};
const removed={'设置':[15,16],'主界面':[2,11,31],'界面选项':[12,13,18],'手势APP选择':[22,23]};
